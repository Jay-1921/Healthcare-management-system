				...
				<div class="col-md-6 my-2 jumbotron">
					...
					<form method="post">
						<div class="form-group">
							...
							<input type="text" name="fname" class="from-control" autocomplete="off" placeholder="Enter Firstname">
						</div>
						
						<div class="form-group">
							<label>Surname</label>
							<input type="text" name="sname" class="from-control" autocomplete="off" placeholder="Enter Surname">
						</div>
						...
						<div class="form-group">
							<label>Email</label>
							<input type="text" name="email" class="from-control" autocomplete="off" placeholder="Enter Email">
						</div>

						<div class="form-group">
							<label>Phone No.</label>
							<input type="text" name="phone" class="from-control" autocomplete="off" placeholder="Enter Phone Number">
						</div>
						...
						<div class="form-group">
							<label>Country</label>
							<select  name="country" class="from-control" >
