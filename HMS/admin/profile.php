...
<body>
    ...
    include("C:\wamp64\www\HMS\include\connection.php");
    $username = '';
    $profile = '';
    $show='';
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php
                                    ...
                                    <input type="submit" name="update_pass" value="
                                    Update Password" class="btn btn-info">
