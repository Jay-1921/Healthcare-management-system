...
<body>
   <nav class="navbar navbar-expand-lg navbar-info bg-info">
   	 <h5 class="navbar-brand text-white"> HRIDAYA Healthcare</h5>
      ...
      <li class="nav-item"><a href="logout.php" class="nav-link
         text-white">logout</a></li>';
            ...
            <li class="nav-item"><a href="adminlogin.php" class="nav-link
               text white">Admin</a></li>
         <li class="nav-item"><a href="doctorlogin.php" class="nav-link
            text white">Doctor</a></li>
         <li class="nav-item"><a href="patientlogin.php" class="nav-link
            text white">Patient</a></li>
            ';
